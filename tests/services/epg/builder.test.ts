...
const programs: Program[] = [
  {
    ...
    startTime: new Date(12, 5, 2022, 4, 0, 0),
    duration: 7200,
  ...
  },
  {
    ...
    startDate: new Date(12, 5, 2022),
    startTime: new Date(12, 5, 2022, 6, 0, 0),
    duration: 5400,
    rating: ProgramRating.RL,
  },
  {
    ...
    startDate: new Date(12, 5, 2022),
    startTime: new Date(12, 5, 2022, 7, 30, 0),
    duration: 5400,
    rating: ProgramRating.RL,
  },
];
...
4015;1;2;1;20220612;040000;013000;"1º Jornal";"As principais notícias do Brasil e do Mundo, com agilidade e prestação de serviços, deixando o telespectador bem informado logo nas primeiras horas da manhã.";0;"0x00";"0x05B3";;"0x10";"0x103";0;1;1;7;"por";;"Estéreo";;"0x11";"0x30";"0xE0";0;2;0;1;"0x00";0;0;0;1;"0x10";0;0;0;1;"0x0008";"0x30";"0113706F72";;"Closed Caption";;;;;;;;;;2;;;"BRA";"0x03";0;0;0;0;;;;;
4016;1;2;1;20220612;060000;020000;"Bora SP";"Programa jornalístico leve, interativo e com muita prestação de serviço, valorizando sempre as notícias locais.";0;"0x00";"0x05B3";;"0x10";"0x0603";0;1;1;7;"por";;"Estéreo";;"0x11";"0x30";"0xE0";0;2;0;1;"0x00";0;0;0;1;"0x10";0;0;0;1;"0x0008";"0x30";"0113706F72";;"Closed Caption";;;;;;;;;;2;;;"BRA";"0x03";0;0;0;0;;;;;
4017;1;2;1;20220612;073000;013000;"Bora Brasil";"As principais informações do Brasil e do Mundo com leveza, interatividade e credibilidade.";0;"0x00";"0x05B3";;"0x10";"0x0603";0;1;1;7;"por";;"Estéreo";;"0x11";"0x30";"0xE0";0;2;0;1;"0x00";0;0;0;1;"0x10";0;0;0;1;"0x0008";"0x30";"0113706F72";;"Closed Caption";;;;;;;;;;2;;;"BRA";"0x03";0;0;0;0;;;;;`;
...
describe('Builder CSV', () => {
  it('should return a valid csv file from a list of programs', () => {
    ...
    expect(csvProgramRows.length).toHaveLength(expectedCsvRows.length);
...
describe('Builder XML', () => {
  it('should return a valid xml file from a list of programs', () => {
    ...
    const xmlPrograms = EPGBuilder.buildXml(programs);
