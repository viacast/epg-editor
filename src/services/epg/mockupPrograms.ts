import { ProgramRating } from './program';
...
export default [
  ...
  {
    title: 'Hatfields & Mccoys - Amor e Guerra',
    description:
  ...
  {
    title: 'Jornal da Band - reapresentação ',
    description:
      'Noticiário diário que apresenta os principais acontecimentos no Brasil e no Mundo com neutralidade e profissionalismo.',
    startDate: '13/05/2022',
    startHour: '02:15:00',
